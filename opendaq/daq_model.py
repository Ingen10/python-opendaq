...
class DAQModel(object):
    ...
    def raw_to_volts(self, raw, gain_id, pinput, inputmode=0, detector=0):
        """
        Convert a raw value or a list of values to units.
        Device calibration values are used for the calculation.

        :param raw: Value or list of values to be converted.
        :param gain_id: ID of the analog configuration setup.
        :param pinput: Analog input number.
        :param inputmode: Configuration mode for this input (shunt on/off, units, etc.).
        :param detector: Mean, RMS or MAX/MIN        
        :returns: Value in units (Volts, mA, ºC or other, depending on the inputmode).
        """
