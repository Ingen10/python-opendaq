...
class InputBase(object):
    ...
    def raw_to_units(self, raw, gain_id, calibreg1, calibreg2, inputmode=0, detector=0):
...
class InputA(InputBase):
    # Basic analog input with MCP6S PGA (output in Volts)
...
class InputAS(InputBase):
    # Similar to A type but with shunt resistor (convert volts to mA)
